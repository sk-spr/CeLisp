...
\doxylink{namespaceCeLishp}{Ce\+Lishp} is a framework for implementing a (domain-\/specific) scripting language into a project.\hypertarget{md_CeLishp_2docs_2README_autotoc_md1}{}\doxysection{\texorpdfstring{Background}{Background}}\label{md_CeLishp_2docs_2README_autotoc_md1}
...
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ \{\ \textcolor{stringliteral}{"{}seven"{}},\ \textcolor{keyword}{new}\ Constant<float>(7f)\ \},\ \textcolor{comment}{//\ We\ define\ "{}seven"{}\ as\ meaning\ a\ constant\ value\ of\ 7}}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
